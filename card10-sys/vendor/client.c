...
int epic_disp_print_adv( uint8_t font, uint16_t posx, uint16_t posy, const char *pString, uint16_t fg, uint16_t bg)
{
        ...
        *(uint16_t*)(epc__apistub_buffer + sizeof(uint8_t)) = posx;
        *(uint16_t*)(epc__apistub_buffer + sizeof(uint8_t) + sizeof(uint16_t)) = posy;
        *(const char **)(epc__apistub_buffer + sizeof(uint8_t) + sizeof(uint16_t) + sizeof(uint16_t)) = pString;
        *(uint16_t*)(epc__apistub_buffer + sizeof(uint8_t) + sizeof(uint16_t) + sizeof(uint16_t) + sizeof(const char *)) = fg;
        *(uint16_t*)(epc__apistub_buffer + sizeof(uint8_t) + sizeof(uint16_t) + sizeof(uint16_t) + sizeof(const char *) + sizeof(uint16_t)) = bg;
